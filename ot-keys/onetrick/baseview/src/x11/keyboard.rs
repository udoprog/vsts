...
pub(super) fn key_mods(mods: KeyButMask) -> Modifiers {
    ...
    let key_masks = [
        ...
        // where the "windows" key seems to be MOD4.
...
pub(super) fn convert_key_press_event(key_press: &xcb::x::KeyPressEvent) -> KeyboardEvent {
...
pub(super) fn convert_key_release_event(key_release: &xcb::x::KeyReleaseEvent) -> KeyboardEvent {
